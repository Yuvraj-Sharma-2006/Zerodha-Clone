   ...
   return (
     <div className="container-fluid">
       <div className="row mt-5 mb-5 text-center">
         <h1 className="fs-4 text-muted mt-5 mb-5">We pioneered the discount broking model in India.<br/>
             Now, we are breaking ground with our technology.</h1>
       </div>

       <div className="row mt-5 py-5 border-top aboutContent">
        <div className="offset-xl-2 col-xl-4 offset-lg-1 col-lg-5 col-md-6 col-12 mt-5 mb-5">
           <p>
